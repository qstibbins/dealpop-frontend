        ...
        <div className="space-y-8 text-sm leading-relaxed" style={{ fontFamily: 'system-ui' }}>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li>Track price changes and identify deals</li>
              <li>Provide price comparison services</li>
              <li>Send notifications about price drops and deals</li>
              <li>Maintain price history for tracked products</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li><strong>Google APIs:</strong> For enhanced functionality and integration</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              We do not share personal information with affiliate partners. Tracking is typically handled through anonymous referral links or cookies provided by the affiliate networks.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <li><strong>Website:</strong> https://dealpop.co</li>
            </ul>
          </section>
